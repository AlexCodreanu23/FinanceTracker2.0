...
namespace FinanceTracker_2._0.Migrations
{
    ...
    [Migration("20250421114415_AddTypeFieldsToTransactionAndAccount")]
    partial class AddTypeFieldsToTransactionAndAccount
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FinanceTracker_2._0.Models.Account", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("FinanceTracker_2._0.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "STATIC_CONCURRENCY_STAMP_VALUE",
                            Email = "testuser@example.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "TESTUSER@EXAMPLE.COM",
                            NormalizedUserName = "TESTUSER",
                            PasswordHash = "AQAAAAIAAYagAAAAEPQomS+W3MP6Yse2HOKVnquyj3bDx9T7IItwFny/Je4mgNtxLp+esioG6IoBDa304g==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "C1A3E9E3-1234-5678-90AB-CDEF12345678",
            ...
            modelBuilder.Entity("FinanceTracker_2._0.Models.Account", b =>
                {
                    b.HasOne("FinanceTracker_2._0.Models.User", "User")
                        .WithMany("Accounts")
            ...
            modelBuilder.Entity("FinanceTracker_2._0.Models.Budget", b =>
                {
                    b.HasOne("FinanceTracker_2._0.Models.Category", "Category")
                        .WithMany("Budgets")
            ...
            modelBuilder.Entity("FinanceTracker_2._0.Models.Transaction", b =>
                {
                    b.HasOne("FinanceTracker_2._0.Models.Account", "Account")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("FinanceTracker_2._0.Models.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
